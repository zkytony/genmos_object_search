...
# 3. In another terminal, run this test 'python test_create_agent_with_map_from_point_cloud.py'
#
...
class TestCase:
    def __init__(self):
        rospy.init_node("test_create_agent_with_map_from_point_cloud")
    ...
    def _cloud_waypoints_callback(self, cloud_msg, waypoints_msg):
        ...
        init_pose_pb = Pose2D(x=waypoints_array[0][0],

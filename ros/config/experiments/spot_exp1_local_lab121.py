...
GLOBAL_DETECTORS = {
    'Cat': {'class': 'genmos_object_search.oopomdp.FanModelAlphaBeta',
            'params': {"sensor": "hand_fan",
                       "quality": [1e5, 0.4]}},
    'Bowl': {'class': 'genmos_object_search.oopomdp.FanModelAlphaBeta',
             'params': {"sensor": "hand_fan",
                        "quality": [1e5, 0.4]}},
    'Columbia Book': {'class': 'genmos_object_search.oopomdp.FanModelAlphaBeta',
                      'params': {"sensor": "hand_fan",
                                 "quality": [1e5, 0.4]}},
    'ToyPlane': {'class': 'genmos_object_search.oopomdp.FanModelAlphaBeta',
                 'params': {"sensor": "hand_fan",
                            "quality": [1e5, 0.4]}},
    'Lyzol': {'class': 'genmos_object_search.oopomdp.FanModelAlphaBeta',
              'params': {"sensor": "hand_fan",
                         "quality": [1e5, 0.4]}},
    'BlackPump': {'class': 'genmos_object_search.oopomdp.FanModelAlphaBeta',
                  'params': {"sensor": "hand_fan",
                             "quality": [1e5, 0.4]}},
    'Pringles': {'class': 'genmos_object_search.oopomdp.FanModelAlphaBeta',
                 'params': {"sensor": "hand_fan",
                            "quality": [1e5, 0.4]}},
    'Robot Book': {'class': 'genmos_object_search.oopomdp.FanModelAlphaBeta',
                 'params': {"sensor": "hand_fan",
                            "quality": [1e5, 0.4]}},
}

## TODO: For local search, publish search region center too.
...
def main():
    ...
    center_pose = (
        ...
        rospy.get_param("{}/center_qx".format(search_region_3d_config_prefix)),
        rospy.get_param("{}/center_qy".format(search_region_3d_config_prefix)),
        rospy.get_param("{}/center_qz".format(search_region_3d_config_prefix)),
        rospy.get_param("{}/center_qw".format(search_region_3d_config_prefix))
    )

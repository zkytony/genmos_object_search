...
# 2. run in a terminal 'roslaunch sloop_object_search_ros sloop_mos_movo_system.launch map_name:=<map_name>'
# 3. run in a terminal 'python -m sloop_object_search.grpc.server'
# 4. run in a terminal, "roslaunch sloop_object_search_ros sloop_mos_movo_exp1_scili8_living_room.launch"
# 5. run rviz, 'roslaunch sloop_object_search_ros view_movo_object_search.launch'

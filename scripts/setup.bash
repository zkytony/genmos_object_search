...
#############################################
# Install spot_utils package
#############################################
if [ ! -d $bdai_path/projects/search/src/spot_utils ]; then
    echo_error "spot_utils package does not exist under $bdai_path/projects/search. Abort."
    exit_on_error
fi
cd $bdai_path/projects/search
pip install .

#############################################
# setup GenMOS ROS 2 package

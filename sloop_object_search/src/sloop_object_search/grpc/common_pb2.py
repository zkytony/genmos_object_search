...
_BASICPARAM = DESCRIPTOR.message_types_by_name['BasicParam']
...
BasicParam = _reflection.GeneratedProtocolMessageType('BasicParam', (_message.Message,), {
  'DESCRIPTOR' : _BASICPARAM,
  '__module__' : 'sloop_object_search.grpc.common_pb2'
  # @@protoc_insertion_point(class_scope:sloop_object_search.grpc.BasicParam)
  })
_sym_db.RegisterMessage(BasicParam)
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _STATUS._serialized_end=680
  _HEADER._serialized_start=100
  _HEADER._serialized_end=186
  _BASICPARAM._serialized_start=188
  _BASICPARAM._serialized_end=251
  _POSE2D._serialized_start=253
  _POSE2D._serialized_end=295
  _POSE3D._serialized_start=297
  _POSE3D._serialized_end=411
  _VEC3._serialized_start=413
  _VEC3._serialized_end=452
  _VEC2._serialized_start=454
  _VEC2._serialized_end=482
  _QUATERNION._serialized_start=484
  _QUATERNION._serialized_end=540
  _BOX3D._serialized_start=542
  _BOX3D._serialized_end=645
